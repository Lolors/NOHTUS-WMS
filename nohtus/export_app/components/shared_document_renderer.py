...
def render_document(case, packed, actual_rows=None) -> None:
    ...
    table_columns = '<colgroup><col style="width:9%"><col style="width:8%"><col style="width:27%"><col style="width:12%"><col style="width:11%"><col style="width:5%"><col style="width:5%"><col style="width:8%"><col style="width:15%"></colgroup>'
