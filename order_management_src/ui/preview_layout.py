...
def render_order_html(core_app, vendor, order_items, request_note, order_id=None, order_date=None):
    ...
    if not rows_html:
        rows_html = '<tr><td colspan="4" class="empty">발주 품목이 없습니다.</td></tr>'
...
.item-table th:nth-child(2), .item-table td:nth-child(2) { width: 60% !important; }
.item-table th:nth-child(3), .item-table td:nth-child(3) { width: 13% !important; }
.item-table th:nth-child(4), .item-table td:nth-child(4) { width: 20% !important; }
</style>
"""
