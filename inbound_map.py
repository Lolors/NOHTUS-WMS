...
def render_inbound_quick_location_map():
    ...
    클릭은 부모 Streamlit 앱의 hidden input/button 브리지와 query parameter fallback으로 전달한다.
    """
...
<div class="inbound-map-card">
  ...
  <div class="map-scroll"><div class="map-stage">
    ...
    <div class="qp">
      <a class="{'selected' if is_selected('Q1') or is_selected('Q2') or is_selected('Q') else ''}" href="?inbound_loc=Q" target="_top" data-inbound-loc="Q"><span class="qp-key qkey">Q</span><span>유통기간임박</span></a>
    ...
    <div class="special-menu" id="inboundSpecialMenu" style="left:975px;top:452px;width:168px;">
      <a href="?inbound_loc=홍보물랙" target="_top" data-inbound-loc="홍보물랙">홍보물랙</a>
      <a href="?inbound_loc=회색 카트" target="_top" data-inbound-loc="회색 카트">회색 카트</a>
      <a href="?inbound_loc=오른쪽 창고" target="_top" data-inbound-loc="오른쪽 창고">오른쪽 창고</a>
      <a href="?inbound_loc=사무실(4층)" target="_top" data-inbound-loc="사무실(4층)">사무실(4층)</a>
      <a href="?inbound_loc=지엠메딕" target="_top" data-inbound-loc="지엠메딕">지엠메딕</a>
    </div>
  </div></div>
</div>
<script>
