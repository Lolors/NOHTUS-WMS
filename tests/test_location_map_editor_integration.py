...
class LocationMapEditorIntegrationTests(unittest.TestCase):
    ...
    def test_saved_json_generates_existing_click_targets_and_styles(self):
        ...
        self.assertIn("const partitionGapX=el.classList.contains('partitioned-rack')", renderer_source)
        self.assertIn('right-left-partitionGapX', renderer_source)
        self.assertIn('bottom-top-partitionGapY', renderer_source)
